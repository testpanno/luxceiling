...
main_cta.addEventListener("mouseover", function (){
    ...
    document.querySelector(".main-cta button img").src = 'luxceiling/assets/img/dark-arrow-left.svg'
})

main_cta.addEventListener("mouseout", function (){
    document.querySelector(".main-cta button").style.background = '#141414'
    document.querySelector(".main-cta button img").src = 'luxceiling/assets/img/arrow-left.svg'
})
...
footer_cta.addEventListener("mouseover", function (){
    ...
    document.querySelector(".footer-cta button img").src = 'luxceiling/assets/img/dark-arrow-left.svg'
})

footer_cta.addEventListener("mouseout", function (){
    document.querySelector(".footer-cta button").style.background = '#141414'
    document.querySelector(".footer-cta button img").src = 'luxceiling/assets/img/arrow-left.svg'
})
